defmodule AutocheckerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AutocheckerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AutocheckerWeb.Gettext, "errors", msg, opts)
    end
  end
